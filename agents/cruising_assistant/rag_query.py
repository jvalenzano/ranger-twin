...
from agents.cruising_assistant.skills.template_lookup import lookup_template
    ...
    **ADK Compatible**: Uses only simple parameter types (str, int, bool).
    ...
    try:
        ...
        if not is_rag_available():
            ...
            logger.info("[RAG-OFFLINE] Defaulting to embedded templates for Cruising Assistant")
            ...
            return {
                ...
                "reasoning_chain": [
                    ...
                    "Retrieved FSH 2409.12 cruise methodology from embedded knowledge"
                ],
                "confidence": 0.85,
                "status": "success",
