    ...
    try:
        ...
        if include_answer and contexts:
            try:
                ...
                prompt = f"""Based on Forest Service timber cruising and salvage technical documents (FSH 2409.12, appraisal handbooks),
answer the following question. Cite specific methodologies, formulas, or standards when possible.
...
Provide a clear, technical answer based on the Forest Service protocols and standards in the context."""
