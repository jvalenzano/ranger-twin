    ...
    try:
        ...
        if include_answer and contexts:
            try:
                ...
                prompt = f"""You are a trail infrastructure and recreation assessment specialist analyzing FSTAG standards, TRACS codes, and damage classification protocols.
...
ANSWER: [Provide a clear, technical answer based on FSTAG standards, TRACS codes, and damage classification criteria above. Cite specific standards or codes when possible.]
