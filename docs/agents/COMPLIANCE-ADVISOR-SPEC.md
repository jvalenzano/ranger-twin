...
> A NEPA planner pastes a draft Environmental Assessment into PolicyPilot and asks, "Does this adequately address watershed protection requirements?" Within 30 seconds, the AI returns a compliance assessment with direct citations to FSM 2520 and FSH 2509.18—complete with paragraph references and links. What used to require three weeks of manual cross-referencing now happens during a coffee break.
...
| Persona | Role | Pain Point | How PolicyPilot Helps |
|---------|------|------------|----------------------|
...
1. **Setup** (1 min): Show PolicyPilot interface, explain regulatory challenge
